...
4. **Immediate documentation** - Update MAESTRO_REGISTRY.md when adding components
...
#### 1. Selection States (S01-S10)
User's current selections and preferences
```lua
SafeRegisterState("Selection.Mode", "none", { id = "S01" })           -- "none", "dungeons", "raid", "custom"
SafeRegisterState("Selection.DungeonNames", {}, { id = "S02" })       -- Array of selected dungeon names
SafeRegisterState("Selection.RaidName", nil, { id = "S03" })          -- Selected raid name or nil
SafeRegisterState("Selection.RaidSize", 40, { id = "S04" })           -- Custom raid size (1-40)
SafeRegisterState("Selection.Roles", {}, { id = "S05" })              -- Array: {"TANK", "HEAL", "DPS"}
SafeRegisterState("Selection.CustomMessage", "", { id = "S06" })      -- Custom broadcast text
SafeRegisterState("Selection.CustomGroupSize", 5, { id = "S07" })     -- Group size for custom messages
SafeRegisterState("Selection.DetailsText", "", { id = "S08" })        -- Additional details text
```

#### 2. Generated States (S09-S15)
Computed values based on selections
```lua
SafeRegisterState("Message.ToBroadcast", "", { id = "S09" })          -- Generated broadcast message
SafeRegisterState("Channels.ActiveChannels", {}, { id = "S10" })      -- Array of active channel names
```

#### 3. System States (S16-S25)
WoW game state and group information
```lua
SafeRegisterState("Group.Size", 1, { id = "S11" })                    -- Current group size (1-40)
SafeRegisterState("Group.Type", "solo", { id = "S12" })               -- "solo", "party", "raid"
SafeRegisterState("Group.IsLeader", false, { id = "S13" })            -- Is player party/raid leader
```

#### 4. Broadcaster States (S26-S35)
Broadcasting system status and metrics
```lua
SafeRegisterState("Broadcaster.IsRunning", false, { id = "S14" })     -- Is broadcaster active
...
SafeRegisterState("Broadcaster.TimeRemaining", 0, { id = "S18" })     -- Seconds until next broadcast
SafeRegisterState("Broadcaster.Interval", 60, { id = "S19" })         -- Broadcast interval (30-7200)
```
