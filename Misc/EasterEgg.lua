...
if not AutoLFM.Misc.EasterEgg then AutoLFM.Misc.EasterEgg = {} end
...
-- Easter Egg Trigger
-----------------------------------------------------------------------------
function AutoLFM.Misc.EasterEgg.Trigger()
...
-- Slash Commands
-----------------------------------------------------------------------------
SLASH_EASTEREGG1 = "/fumier"
SLASH_EASTEREGG2 = "/petfoireux"
SlashCmdList["EASTEREGG"] = function()
  AutoLFM.Misc.EasterEgg.Trigger()
end
