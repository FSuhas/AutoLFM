...
local function CreateRaidRow(parent, raid, index, yOffset)
    ...
    local frame = AutoLFM.UI.Components.PanelBuilder.CreateSelectableRow{
        parent = parent,
...
function AutoLFM.UI.RaidsPanel.ClearSelection()
    ...
    AutoLFM.UI.Components.PanelBuilder.ClearCheckboxes(checkButtons)
    SetFixedSizeState()
end
...
function AutoLFM.UI.RaidsPanel.UpdateCheckboxes()
    ...
    AutoLFM.UI.Components.PanelBuilder.UpdateCheckboxes(checkButtons, AutoLFM.Logic.Content.IsRaidSelected)
end

function AutoLFM.UI.RaidsPanel.UpdateSizeControls()
...
function AutoLFM.UI.RaidsPanel.CreateSizeSlider(bottomZone)
  ...
  raidSizeSlider = AutoLFM.UI.Components.PanelBuilder.CreateSlider({
...
function AutoLFM.UI.RaidsPanel.Init()
    ...
    local panelData = AutoLFM.UI.Components.PanelBuilder.CreatePanel(parent, "AutoLFM_RaidsPanel")
    if not panelData then return end

    mainFrame = panelData.panel
    panelData = AutoLFM.UI.Components.PanelBuilder.AddScrollFrame(panelData, "AutoLFM_ScrollFrame_Raids")
...
function AutoLFM.UI.RaidsPanel.Register()
    AutoLFM.UI.Components.TabNavigation.RegisterPanel("raids",
