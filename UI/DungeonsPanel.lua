...
local function CreateDungeonRow(parent, dungeon, priority, yOffset)
  ...
  local row = AutoLFM.UI.Components.PanelBuilder.CreateSelectableRow({
    parent = parent,
...
local function UpdateRowVisibility()
  ...
  for _, f in pairs(dungeonRows) do
    if f then AutoLFM.UI.Components.PanelBuilder.UpdateScrollHeight(f:GetParent(), visible) break end
  end
end
...
function AutoLFM.UI.DungeonsPanel.ClearSelection() if AutoLFM.Logic.Content.ClearDungeons then AutoLFM.Logic.Content.ClearDungeons() end AutoLFM.UI.Components.PanelBuilder.ClearCheckboxes(checkButtons) end
function AutoLFM.UI.DungeonsPanel.ClearBackdrops() AutoLFM.UI.Components.PanelBuilder.ClearBackdrops(clickableFrames) end
function AutoLFM.UI.DungeonsPanel.UpdateCheckboxes() if AutoLFM.Logic.Content.IsDungeonSelected then AutoLFM.UI.Components.PanelBuilder.UpdateCheckboxes(checkButtons, AutoLFM.Logic.Content.IsDungeonSelected) end end
...
function AutoLFM.UI.DungeonsPanel.Init()
  ...
  local p = AutoLFM.UI.Components.PanelBuilder.CreatePanel(parent, "AutoLFM_DungeonsPanel")
  if not p then return end
  mainFrame = p.panel mainFrame:Show()
  p = AutoLFM.UI.Components.PanelBuilder.AddScrollFrame(p, "AutoLFM_ScrollFrame_Dungeons")
...
function AutoLFM.UI.DungeonsPanel.Register()
  AutoLFM.UI.Components.TabNavigation.RegisterPanel("dungeons",
