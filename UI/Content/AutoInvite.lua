...
function AutoLFM.UI.Content.AutoInvite.OnEnableRadioClick(isEnabled)
  ...
  if AutoLFM.Core.Persistent and AutoLFM.Core.Persistent.SetAutoInviteEnabled then
    AutoLFM.Core.Persistent.SetAutoInviteEnabled(isEnabled)
...
function AutoLFM.UI.Content.AutoInvite.OnConfirmRadioClick(isEnabled)
  ...
  -- Save to persistent storage
  if AutoLFM.Core.Persistent and AutoLFM.Core.Persistent.SetAutoInviteConfirm then
    AutoLFM.Core.Persistent.SetAutoInviteConfirm(isEnabled)
...
function AutoLFM.UI.Content.AutoInvite.OnRandomMessagesRadioClick(isEnabled)
  ...
  -- Save to persistent storage
  if AutoLFM.Core.Persistent and AutoLFM.Core.Persistent.SetAutoInviteRandomMessages then
    AutoLFM.Core.Persistent.SetAutoInviteRandomMessages(isEnabled)
...
function AutoLFM.UI.Content.AutoInvite.OnRespondNotLeaderRadioClick(isEnabled)
  ...
  -- Save to persistent storage
  if AutoLFM.Core.Persistent and AutoLFM.Core.Persistent.SetAutoInviteRespondWhenNotLeader then
    AutoLFM.Core.Persistent.SetAutoInviteRespondWhenNotLeader(isEnabled)
...
function AutoLFM.UI.Content.AutoInvite.OnKeywordTextChanged(index, text)
  ...
  local keywords = AutoLFM.Core.Persistent.GetAutoInviteKeywords() or {}
  ...
  if AutoLFM.Core.Persistent and AutoLFM.Core.Persistent.SetAutoInviteKeywords then
    AutoLFM.Core.Persistent.SetAutoInviteKeywords(keywords)
  end
end
...
function AutoLFM.UI.Content.AutoInvite.RefreshPanel()
  ...
  if scrollChild then
    ...
    local isEnabled = AutoLFM.Core.Persistent.GetAutoInviteEnabled()
    local isConfirmEnabled = AutoLFM.Core.Persistent.GetAutoInviteConfirm()
    local useRandomMessages = AutoLFM.Core.Persistent.GetAutoInviteRandomMessages()
    local respondWhenNotLeader = AutoLFM.Core.Persistent.GetAutoInviteRespondWhenNotLeader()
    local keywords = AutoLFM.Core.Persistent.GetAutoInviteKeywords() or {}
