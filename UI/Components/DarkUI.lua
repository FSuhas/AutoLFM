...
if not AutoLFM.UI.Components.DarkUI then AutoLFM.UI.Components.DarkUI = {} end
...
-- Core Darkening
-----------------------------------------------------------------------------
function AutoLFM.UI.Components.DarkUI.DarkenFrame(frame)
  if not enabled then return end
  if not frame then return end

  ProcessRolesBackground(frame)
  ProcessChildren(frame, AutoLFM.UI.Components.DarkUI.DarkenFrame)
...
local function ApplyDarkTheme()
  ...
  for _, frame in pairs(darkenedFrames) do
    if frame then
      AutoLFM.UI.Components.DarkUI.DarkenFrame(frame)
    end
  end
end
...
-- Public API
-----------------------------------------------------------------------------
function AutoLFM.UI.Components.DarkUI.RegisterFrame(frame)
  if not frame then return end
...
function AutoLFM.UI.Components.DarkUI.RefreshFrame(frame)
  if not enabled then return end
  if not frame then return end
  AutoLFM.UI.Components.DarkUI.DarkenFrame(frame)
end

function AutoLFM.UI.Components.DarkUI.Enable()
  enabled = true
  ApplyDarkTheme()
...
function AutoLFM.UI.Components.DarkUI.Disable()
  enabled = false
...
function AutoLFM.UI.Components.DarkUI.Toggle()
  if enabled then
...
function AutoLFM.UI.Components.DarkUI.IsEnabled()
  return enabled
end
...
-- Initialization
-----------------------------------------------------------------------------
function AutoLFM.UI.Components.DarkUI.Init()
  if AutoLFM and AutoLFM.Core and AutoLFM.Core.Settings then
