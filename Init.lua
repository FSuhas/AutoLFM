...
function AutoLFM.Init.Run()
  ...
  Call("Logic.ActionState.Init")
  Call("Logic.Selection.Init")

  Call("UI.Components.DarkUI.Init")
  Call("UI.Components.MainWindow.Init")

  Call("UI.DungeonsPanel.Init")
  Call("UI.RaidsPanel.Init")
  Call("UI.QuestsPanel.Init")
  Call("UI.MorePanel.Init")
  Call("UI.PresetPanel.Init")
  Call("UI.OptionsPanel.Init")

  Call("UI.Components.LineTabs.Init")
  Call("UI.Components.TabNavigation.Init")
  Call("UI.Components.WelcomePopup.Init")
  Call("UI.Components.MinimapButton.Init")
  Call("UI.Components.LinkIntegration.Init")
